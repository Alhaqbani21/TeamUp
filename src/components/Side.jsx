...
function Side() {
  return (
    <aside className="h-full max-sm:absolute w-32 flex flex-col space-y-10 items-start justify-center  relative text-white border-gray-400 z-50">
      <div className="h-max  ps-1 w-16 flex flex-col max-sm:flex-row max-sm:w-full max-sm:items-center max-sm:fixed max-sm:bottom-0  space-y-6 items-start justify-center relative bg-primary max-sm:rounded-sm rounded-r-3xl hover:w-32 group hover:ps-0 hover:bg-white hover:text-gray-800 transition-all duration-300 ease-linear">
