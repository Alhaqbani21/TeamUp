...
function MatchCard({
  ...
  return (
    <Fade triggerOnce={true} direction="right" className="w-[90%]">
      ...
      >
        <div className="absolute inset-0 bg-black opacity-70 filter blur-lg"></div>
        <div className="relative p-4 flex flex-col justify-center">
          <div className="flex justify-between items-center border-b-[1px] py-2">
            <div className="flex flex-col justify-center">
              ...
              <p className="text-sm  font-bold text-gray-300 mt-3">
                {distance}
              </p>
                  ...
                  >
                    ...
                    <div className="text-wrap">
                      {player.name ? (
                        ...
                        <button
                          className={`text-sm  px-4 py-2 max-md:text-xs bg-gray-700 rounded-lg transition-all font-medium tracking-widest ${
                            isRejected
