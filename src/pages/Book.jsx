...
//     ? data.filter((e) => e.sport === selectedSport)
//     : data;
...
//             <Cardheder onSelectSport={handleSelectSport} />
//           </div>

//           <main className="max-w-full h-full flex relative ">
//             <div className="w-full p-4">
//               <h2 className="text-center text-3xl p-2 tracking-widest text-[#007955]">
//                 {selectedSport ? `${selectedSport} Stadiums` : "All Stadiums"}
//               </h2>
//               <div className="flex space-x-2 justify-center items-center max-sm:flex-col h-min">
