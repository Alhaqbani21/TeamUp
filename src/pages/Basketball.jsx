  ...
  return (
    <main className="hero min-h-screen rounded-xl  ">
      <div className="w-[75vw]  max-sm:flex-col max-sm:items-center  max-sm:w-full gap-9 bg-base-100 rounded-lg flex">
        ...
        <DetailePlayers  PlayersA={PlayersA} PlayersB={PlayersB} teamA={teamA}  time='17 Jul, 8:00PM-10:30PM' cost='100 SAR' location='Basketball Ground' map="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115924.67751812687!2d46.81571805664062!3d24.773317900000027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2efd86c4a30495%3A0xa15081d4f13a3998!2z2YXZhNi52Kgg2YPYsdipINin2YTYs9mE2KkgLSBCYXNrZXRiYWxsIEdyb3VuZA!5e0!3m2!1sar!2ssa!4v1721076770611!5m2!1sar!2ssa"/>
